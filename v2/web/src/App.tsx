...
import { OpenShiftConsole } from './OpenShiftConsole';
...
function App() {
  ...
  const currentView = activeView;
	...
	if (liveMode) return <OpenShiftConsole api={api} organization={organization} project={project} onDisconnect={disconnect} />;
